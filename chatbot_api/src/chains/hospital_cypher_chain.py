...
Do not include anything other than the query in the responses.
Do not add any header with the query result (like 'Answer is' 'cypher query' 'Answer' or other headers), return only the query directly.
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=HuggingFaceEndpoint(
